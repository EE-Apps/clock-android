...
import com.eenot.clock.WeatherClockWidget;
import com.eenot.clock.widget.BaseWidgetConfigActivity;
import com.eenot.clock.widget.WidgetPrefs;

public class WeatherClockWidgetConfigActivity extends BaseWidgetConfigActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.widget_weather_clock_config);
    ...
    protected void applySettings() {
        ...
        updateIntent.setComponent(new ComponentName(this, WeatherClockWidget.class));
