...
public class BlackDateWidgetConfigActivity extends BaseWidgetConfigActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.widget_black_date_config);
    ...
    protected void applySettings() {
        ...
        updateIntent.setComponent(new ComponentName(this, BlackDateWidget.class));
