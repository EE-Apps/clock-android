...
import com.eenot.clock.widget.BlackClockWidget;
import com.eenot.clock.widget.BaseWidgetConfigActivity;
import com.eenot.clock.widget.WidgetPrefs;

public class BlackClockWidgetConfigActivity extends BaseWidgetConfigActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.widget_black_clock_config);
    ...
    protected void applySettings() {
        ...
        updateIntent.setComponent(new ComponentName(this, BlackClockWidget.class));
